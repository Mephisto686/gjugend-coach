...
function LibraryPage({exercises,onSave,onDelete,apiKey,toast}) {
  ...
  const printExercises=(exList)=>{
    ...
    const css=`*{box-sizing:border-box}body{font-family:-apple-system,system-ui,sans-serif;padding:24px;max-width:820px;margin:0 auto;color:#111}.footer{margin-top:24px;font-size:11px;color:#9ca3af;text-align:center;padding-top:12px;border-top:1px solid #e5e7eb}img{max-height:none!important;height:auto!important;width:100%!important;display:block!important;object-fit:contain!important}@media print{body{padding:12px}@page{margin:1.5cm}img{max-height:none!important;height:auto!important;page-break-inside:avoid;break-inside:avoid}}`;
...
function ManualTrainingPlanner({exercises,players,coachesList=[],onClose,onSaveSession,apiKey,toast,setup,replaceId}) {
  ...
  const printPlan=()=>{
    ...
    const css=`*{box-sizing:border-box}body{font-family:-apple-system,system-ui,sans-serif;padding:24px;max-width:820px;margin:0 auto;color:#111;font-size:14px}h1{font-size:24px;margin:0 0 4px}.meta{font-size:13px;color:#6b7280;margin-bottom:14px;padding-bottom:12px;border-bottom:2px solid #e5e7eb}.footer{margin-top:20px;font-size:11px;color:#9ca3af;text-align:center;padding-top:12px;border-top:1px solid #e5e7eb}img{max-width:100%;height:auto!important;display:block}img{max-height:none!important;height:auto!important;width:100%!important;display:block!important;object-fit:contain!important}@media print{body{padding:12px}@page{margin:1.5cm}img{max-height:none!important;height:auto!important;page-break-inside:avoid;break-inside:avoid}}`;
